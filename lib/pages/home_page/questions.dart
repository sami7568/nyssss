...
import 'package:project1/model/ansModel.dart';
    ...
    await questionsdata.forEach((element) {
      if (element.questionType == QuestionType.YES_NO) {
        ...
        print("yes/no addedd");
          ...
          QuestionType.POOR_FAIR_GOOD_EXCELLENT) {
        setState(() {
          index = index + 1;
        });
                      ...
                      children: [
                        ...
                        new Flexible(
                          child: new ListView.builder(
                              itemCount:
                                  questionsdata.length ?? questionsdata.length,
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            answerlist.forEach((element) {
                              if (element.textEditingControllercontroller.text
                                  .isEmpty) {
                                //
                              ...
                              answerDataList.add(
                                  element.textEditingControllercontroller.text);
                            });
                            ...
                            poorlist.forEach((element) {
                              if (element.val == 1) {
                                ...
                                final snackBar = SnackBar(
                                    content: Text(
                                        "One or more mulitple radio button is empty"));
                                scaffoldKey.currentState
                                    // ignore: deprecated_member_use
                                    .showSnackBar(snackBar);
                                finalAnswer.clear();
                                ...
                                finalAnswer.forEach((element) {
                                  print("cheking answer list on wrong");
                                  print(element);
                                });
                                setState(() {
                                  noError=true;
                            ...
                            showDialog(
                                builder: (BuildContext context) {
                                  return ProgressDialog(
                                    message: "Sending Answers! Please Wait",
                                  );
                                },
                                barrierDismissible: false,
                                context: context);

                              await apiServices.addResult(
                                  finalQuestionId,
                                  widget.email,
                                  widget.email,
                                  finalAnswer,
